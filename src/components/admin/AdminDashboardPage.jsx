...
function AdminDashboardPage() {
  ...
  const recentRecipes = Array.isArray(stats?.recentRecipes) ? stats.recentRecipes : []
    ...
    <AdminLayout>
      <div className="space-y-12">
        ...
        <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-4">
          <StatCard icon={<FiUsers />} title="Total Users" value={stats.totalUsers || 0} trend="4" />
          <StatCard icon={<FiFileText />} title="Recipes" value={stats.totalRecipes || 0} trend="6" />
          <StatCard icon={<FiLayers />} title="Categories" value={stats.totalCategories || categories.length || 0} />
          <StatCard icon={<FiFlag />} title="Active Reports" value={stats.openReports || 0} trend="-2" />
        </div>
        ...
        <div className="grid gap-10 xl:grid-cols-2">
          <section>
            ...
            <div className="space-y-4">
              {recentRecipes.length === 0 ? (
                <div className="rounded-3xl border border-surface-100 bg-white p-5 text-surface-500">
                ...
                recentRecipes.map((recipe, i) => (
                  ...
                  >
                    ...
                    <Link
                      to={`/admin/recipes/${recipe?.recipeId}`}
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-4">
              {categories.length === 0 ? (
                <div className="col-span-2 rounded-3xl border border-surface-100 bg-white p-5 text-surface-500">
